...
<form method="post" action="burrowersAction.asp">
    <label for="burrowerName">Burrower Name</label>
    <input type="text" id="burrowerName" name="burrowerName" required>

    <label for="phonenumber">Phone Number</label>
    <input type="number" id="phonenumber" name="phonenumber" minlength="11" maxlength="11" required><br />
