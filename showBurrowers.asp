...
<%
   sql="SELECT burrowerID, burrowerName, phonenumber, Address FROM Burrowers"
...
<%
    ...
    <tr>
      ...
      <td>
        <form action="delBurrower.asp" method="post">
          <input type="hidden" name="burrowerID" value="<%= rs("burrowerID") %>">
          <input type="submit" value="Delete">
        </form>
      </td>
      <td>
         <form action="updateBurrowers.asp" method="post">
          <input type="hidden" name="burrowerID" value="<%= rs("burrowerID") %>">
