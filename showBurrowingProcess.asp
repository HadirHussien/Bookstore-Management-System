...
<%
   sql="SELECT burrowingID, bookName, burrowerName, burrowDate, returnDate FROM BurrowingProcess"
...
<%
    ...
    <tr>
      <td><%= rs("bookName") %></td>
      <td><%= rs("burrowerName") %></td>
      <td><%= rs("burrowDate") %></td>
      <td><%= rs("returnDate") %></td>
   
      <td>
        <form action="delBurrowingProcess.asp" method="post">
          <input type="hidden" name="burrowingID" value="<%= rs("burrowingID") %>">
          <input type="submit" value="Delete">
        </form>
      </td>
      <td>
         <form action="updateBurrowingProcess.asp" method="post">
          <input type="hidden" name="burrowingID" value="<%= rs("burrowingID") %>">
