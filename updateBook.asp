...
sql= "SELECT bookName, authorName, publisher, publicationYear from Books WHERE bookID="&bookID&""
...
publicationYear= rs("publicationYear")
rs.movenext
wend
rs.close
    %>	
...
<div class="content">
    ...
    <form method="post" action="updateBookAction.asp">
    ...
    Publication Year <input type="Text" name="publicationYear" value="<%= publicationYear %>"><br />
