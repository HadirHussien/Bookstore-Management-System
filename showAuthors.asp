...
<%
   sql="SELECT authorID, authorName, phonenumber, bookName FROM Authors"
...
<%
    ...
    <tr>
      ...
      <td>
        <form action="delAuthor.asp" method="post">
          <input type="hidden" name="authorID" value="<%= rs("authorID") %>">
          <input type="submit" value="Delete">
        </form>
      </td>
      <td>
         <form action="updateAuthor.asp" method="post">
          <input type="hidden" name="authorID" value="<%= rs("authorID") %>">
