...
<%   burrowerID=""
    ...
    if burrowerID ="" then 
       burrowerID = Request.QueryString("burrowerID")
    end if

sql= "SELECT burrowerName, phonenumber, address from Burrowers WHERE burrowerID="&burrowerID&""
...
<div class="content">
    ...
    <form method="post" action="updateBurrowersAction.asp">
    <input type="hidden" name="burrowerID" value="<%=burrowerID %>" />
